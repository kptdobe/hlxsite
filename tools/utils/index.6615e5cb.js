...
})({"5DAtO":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
function updateStatus() {
    ...
    SEARCH_STATUS_PANEL.innerHTML = `Matched Files: ${totalFilesMatched} / ${totalFiles} (${humanFileSize(totalSize, true)}) ${seconds}s`;
}
async function fgrep(url, pattern) {
    const u = new URL(url);
    let pathname = u.pathname;
    if (pathname.endsWith('/')) pathname = `${pathname}index`;
    const resp = await fetch(`${config.fields.searchHost}${pathname}.md`);
    ...
    return {
        ...
        status,
        pathname: u.pathname,
        url: `${config.fields.searchHost}${u.pathname}`
    };
}
...
async function edit(url, y) {
    try {
        const config1 = toHelixConfig(url);
...
async function fgrepFiles(sitemap, pattern, connections) {
    ...
    for(let c = 0; c < connections; c += 1)fgrepNextFile(queue, pattern);
}
async function doSearch() {
    ...
    fgrepFiles(filteredURLs, pattern, +connections);
}
const attachListeners = ()=>{
    _fieldsJs.attachOptionFieldsListeners(config.fields);
...
const init = ()=>{
    config.fields = _fieldsJs.initOptionFields('.search');
    setupUI();
    attachListeners();
};
init();

},{"./fields.js":"c1t4u","./sitemap.js":"cpUCd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c1t4u":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const attachOptionFieldsListeners = (fields)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5DAtO","8gVq6"], "8gVq6", "parcelRequire99f1")
